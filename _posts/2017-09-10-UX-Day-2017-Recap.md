...
Goals
1.       UX bekannter zu machen und zu zeigen, dass UX nicht nur eine Sache von UX-Design ist, sondern auch Business und Technologie angeht. (not checked, started)
2.       Die UX Truppe (Design-Office, Barcelona, Skt. Gallen, LexOffice, Topas, Smart-Steuer: inzwischen doch Recht groß) zusammen zu bringen und zu einem stetigen Networking anzuregen. (check)
3.       Das Design-Office in die Mitte des UX-Prozesses zu positionieren. (check)
